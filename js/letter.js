...
const textContainer = document.querySelector('.text__letter');
...
function startTyping() {
    ...
    typingInterval = setInterval(() => {
        if (index < letterContent.length) {
            ...
            const container = textContainer || textLetter.parentElement;
...
btnLetter.addEventListener("click", () => {
    ...
    // ensure container scroll starts at top for new opening
